...
class TubeTest {
    ...
    void getNormal() {
        ...
        // checks weather the getNormal function for Tube works correctly
        ...
        //in case that the point P is orthogonal to P0 the dotProduct between t and axisRay will throw exception
