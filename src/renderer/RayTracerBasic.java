...
public class RayTracerBasic extends RayTracerBase {
    ...
    public Double3 avgT(Vector l, Vector n, LightSource lightSource, Intersectable.GeoPoint gp, double r, double numOfrays){
        Ray ray;
        Vector v;
        Point p;
        Double3 k;
