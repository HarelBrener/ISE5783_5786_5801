...
public class Point {
    ...
    public Point randomPoint(Vector l, double r){
        ...
        double upperBound = r;
        double lowerBound = 0;
        k = rand.nextDouble(upperBound - lowerBound + 1) + lowerBound;
        t = rand.nextDouble(upperBound - k + 1) + lowerBound;
        if(Math.sqrt(k*k + t*t) < r) {
            Vector v = vUp.scale(k).add(vRight.scale(t));
